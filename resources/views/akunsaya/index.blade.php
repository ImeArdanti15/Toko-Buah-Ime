        ...
        <nav class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div id="navMobile" class="hidden transition-all duration-300">
                <ul class="py-20 absolute h-[100vh] grid place-items-center inset-0 bg-slate-900 capitalize z-50">
                    ...
                    <li>
                        <a href="" class="hover:text-lime-500 transition-all duration-300">Kesukaan</a>
                    </li>
                    <li>
            ...
            <div id="main" class="container mx-auto px-4">
                <div class="md:flex w-full">
                    ...
                    <div class="text-center mb-12 md:text-left md:w-1/2 md:pr-10">
                        ...
                        <h1
                            class="font-bold text-3xl mb-4 md:mb-6 md:text-4xl md:leading-relaxed leading-snug capitalize">
                            Pastikan selalu ada <span class="text-red-500">Buah</span> dan <span
                                class="text-lime-500">Sayur</span> di meja. </h1>
                        <p class="leading-relaxed mb-12 text-sm capitalize md:text-base md:pr-10">Sebagian besar
                            buah-buahan yang sudah atau belum Anda ketahui kaya akan nutrisi dan gizi yang dibutuhkan
                            oleh tubuh. Dari semua manfaat yang akan Anda dapatkan, meningkatkan daya ingat sekaligus
                            melindungi sel-sel otak adalah salah satu dari dua poin yang diberikan sayur dan buah.</p>
                        <a href="" class="btn bg-lime-500 text-white">Pesan Sekarang ! <i
                    ...
                    <div class="md:w-1/2 relative">
                        ...
                        <div class="absolute top-1/2 -left-5">
                            <div class="max-w-44 bg-white rounded-md py-3 pl-2 pr-1 capitalize ">
                                <h3 class="text-sm font-bold text-slate-950 mb-1 "><i
                                        class="fa-solid fa-quote-left"></i> <br>Jangan Malas Makan Buah dan Sayur</h3>
                                <p class="text-xs text-slate-700 italic">Harta karun yang terbaik tersembunyi di dalam
                                    buah dan sayur.<i class="fa-solid fa-quote-right"></i></p>
                            </div>
                        </div>
                        <!-- end card -->
                    </div>
        ...
        <header id="category" class="w-full py-20">
            <div class="container mx-auto px-4">
                ...
                <div class="capitalize text-center mb-12">
                    ...
                    <h1 class="font-bold text-2xl leading-snug mx-auto md:-3xl md:max-w-lg">Belanja buah dan sayur di
                        Me<span class="text-lime-500">Fresh</span> </h1>
                ...
                <div class="grid md:grid-cols-4 md:gap-6 ">
                    <!-- card -->
                    <div
                        class="py-3 px-4 border border-lime-500 rounded-md mb-4 capitalize md:mb-1 md:border-lime-500 text-center hover: bg-lime-100 hover:text-slide-950 group transition-all duration-300">
                        <div class="mb-1">
                            <i class="fa-solid fa-lemon"></i>
                        </div>
                        <h2 class="font-semibold mb-2">Buah Segar</h2>
                        <p class="text-sm text-slate-500 group-hover:text-slite-900">Buah-buahan segar berasal dari
                            pertanian Indonesia.</p>
                    </div>

                    <div
                        class="py-3 px-4 border border-lime-500 rounded-md mb-4 capitalize md:mb-1  md:border-lime-500 text-center hover: bg-lime-100 group transition-all duration-300">
                        <div class="mb-1">
                            <i class="fa-solid fa-apple-whole"></i>
                        </div>
                        <h2 class="font-semibold mb-2">Buah Lokal Segar</h2>
                        <p class="text-sm text-slate-500 group-hover:text-slite-900">pemilihan perkebunan yang bagus
                            sehingga hasil tanaman yang berkualitas.</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm text-slate-500 group-hover:text-slite-900">sayuran segar yang berasal dari
                            pertanian Indonesia.</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm text-slate-500 group-hover:text-slite-900">rempah-rempah dari pertanian
                            Indonesia.</p>
                    </div>
                    <!-- end card -->
                </div>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col items-center md:flex-row">
                    ...
                    <div id="joinkiri" class="capitalize mb-12 md:pl-10 md:mb-0 md:w-1/2 md:order-2">
                        ...
                        <h1 class="font-bold text-2xl text-center leading-snug mb-8 md:text-start md:text-3xl">banyak
                            keuntungan dari belanja sayur dan buah di Me<span class="text-lime-500">Fresh</span>.</h1>
                    ...
                    <div id="joinkanan" class="nd:w-1/2 relative">
                        ...
                        <!-- card buah -->
                        <div
                            class="bg-white max-w-[180px] px-3 py-4 rounded-md absolute top-6 left-5 md:top-1/2 border border-lime-500">
                            <h1 class="text-slate-900 capitalize font-bold text-center mb-4 text-sm">produk terbaru
                            </h1>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex justify-between items-end mb-12">
                        ...
                        <div class="capitalize max-w-80">
                            ...
                            <h1 class="font-bold text-2xl leading-snug mx-auto  md:text-3xl md:max-w-lg">Produk
                                kualitas terbaik, terbaru, dan tentunya segar ada di Me<span
                                    class="text-lime-500">Fresh</span></h1>
                        </div>
                        <!-- end kiri -->
                        ...
                        <div class=" mb-3 hidden md:block">
                            <a href="{{ route('produk') }}"
                                class="w-full inline-block text-center rounded-md font-semibold py-3 px-6 text-sm border border-lime-500 text-lime-500 hover:opacity-70">Lihat
                                semua</a>
                        </div>
                    </div>
                    <!-- end kanan -->
                    ...
                    <div class="grid grid-cols-3 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-md overvlow-hidden">
                            ...
                            <div class="mt-6 capitalize px-4 pb-8">
                                ...
                                <p class="font-medium text-slate-500">Rp 49.990,00 /kg</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-md overvlow-hidden">
                            ...
                            <div class="mt-6 capitalize px-4 pb-8">
                                ...
                                <p class="font-medium text-slate-500">Rp 45.500,00 /kg</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-md overvlow-hidden">
                            <div
                                ...
                                <div class="w-[80%] h-[180px]">
                                    <img src="card/ketumbar.jpeg" alt=""
                                        class="w-full h-full object-cover rounded-md" />
                                </div>
                            </div>
                            <div class="mt-6 capitalize px-4 pb-8">
                                ...
                                <p class="font-medium text-slate-500">Rp 20.000,00 /kg</p>
                            </div>
                        </div>
                    </div>
                    <!-- end card -->
