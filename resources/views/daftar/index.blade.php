        ...
        <div class="relative flex flex-col m-r space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            <div class="flex flex-col justify-center p-8 md:p-14">
                ...
                <div class="py-4">
                    ...
                    <input type="password" name="pass" id="pass" class="w-full p-2 border border-lime-500 rounded-md placeholder:font-light placeholder:text-gray-500" placeholder="password">
                </div>
                <div class="py-4">
                    <span class="mb-2 text-md text-lime-600">Nomor Telephone</span>
                    <input type="text" name="pass" id="pass" class="w-full p-2 border border-lime-500 rounded-md placeholder:font-light placeholder:text-gray-500" placeholder="nomor telephone">
                </div>
                <div class="py-4">
                    <span class="mb-2 text-md text-lime-600">Alamat</span>
                    <textarea name="alamat" id="alamat" class="w-full p-2 border border-lime-500 rounded-md placeholder:font-light placeholder:text-gray-500" placeholder="Silahkan masukkan alamat anda "></textarea>
                </div>
            ...
            <div class="relative">
                <img src="fruit10.jpeg" alt="" class="w-[400px] h-full hidden rounded-r-2xl md:block object-cover">
