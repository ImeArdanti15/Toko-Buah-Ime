...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Produk</li>
    </ul>
    ...
    <li>
        ...
        <ul class="dropdown-menu hidden py-1.5 rounded-md bg-white border border-lime-100 w-full max-w-[140px]">
        </ul>
    </li>
    </ul>
    </div>
            ...
            <div class="bg-white border border-lime-100 shadow-md shadow-lime-600/100 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full main-w-[600px]">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Jumlah Stok</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Gambar 1</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Gambar 2</th>
