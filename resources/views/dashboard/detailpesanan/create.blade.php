...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Menambahkan Detail Pesanan</li>
    </ul>
                ...
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <h3 class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 mb-5 w-[200px]">Menambahkan Detail Pesanan</h3>
                                <div class="py-4">
                                ...
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Pesanan</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="pesanan" id="pesanan">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Jumlah</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="jumlah" id="jumlah">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Subtotal</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="subtotal" id="subtotal">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Keterangan</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="keterangan" id="keterangan">
                                </div>
                                <div class="flex justify-end">
                                <button type="button"  onclick="cancel()" class="bg-red-200 text-sm font-medium text-red-600 py-2 px-4 rounded-md hover:text-white  active mr-2 mb-5 w-[100px]">Batal</button>
                                <button type="submit" class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md hover:text-white active mr-2 mb-5 w-[100px]">Simpan</button>
                                </div>
                            </thead>
                            <tbody>
