...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Detail Pesanan</li>
    </ul>
            ...
            <div class="bg-white border border-lime-100 shadow-md shadow-lime-600/100 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="flex items-center mb-5 order-tab">
                        <a href="{{route ('detailpesanan.create')}}" class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 hover:text-white"><i class="fa-solid fa-plus"></i> Tambah Detail Pesanan</a>
                    </div>
                    </div>
                    <div class="">
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Jumlah</th>
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Subtotal</th>
                            ...
                            <tbody>
                                @foreach ($detailpesanan as $idx => $data)
                                                        <tr>
                                                            <td>
