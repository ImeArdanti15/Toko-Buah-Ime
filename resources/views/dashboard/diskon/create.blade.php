...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Menambahkan Diskon</li>
    </ul>
                ...
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <h3 class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 mb-5 w-[200px]">Menambahkan Diskon</h3>

                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Kategori Diskon</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="kategoriproduk" id="kategoriproduk">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Nama Produk</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="namaproduk" id="namaproduk">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Diskon Mulai</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="diskonmulai" id="diskonmulai">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Diskon Selesai</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="diskonselesai" id="diskonselesai">
                                </div>
