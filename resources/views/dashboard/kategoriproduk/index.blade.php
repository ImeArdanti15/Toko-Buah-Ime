...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Kategori Produk</li>
    </ul>
                    ...
                    <div class="">
                        <table class="w-full  main-w-[540px]">
                            ...
                            <div class="flex items-center mb-5 order-tab">
                                <a href="{{route ('kategoriproduk.create')}}" class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 hover:text-white"><i class="fa-solid fa-plus"></i> Tambah Kategori</a>
                            </div>
                            <tbody>
                                @foreach ($kategoriproduk as $idx => $data)
                                <tr>
                                    <td>
