...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Menambahkan Pelanggan</li>
    </ul>
    <ul class="ml-auto flex items-center">
    <li class="mr-1">
        <button type="button" class=" text-lime-600 w-8 h-8 rounded-md flex items-center justify-center hover:bg-lime-50 hover:text-gray-500">
        <i class="fa-solid fa-magnifying-glass"></i>
        </button>
        <div class=" hidden max-w-xs w-full bg-white rounded-md border-lime-300">
            ...
            <div class="bg-white border border-lime-100 shadow-md shadow-lime-600/100 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        <form action="{{ route('pelanggan.store') }}" method="post" id="form">
                            @csrf
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <h3 class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 mb-5 w-[200px]">Menambahkan Pelanggan</h3>
                                <div class="py-4">
                                ...
                                <div class="py-4">
                                    ...
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="email" id="email">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Password</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="password" id="password">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Nomor Telepon</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="notelp" id="notelp">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Alamat 1</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="alamat1" id="alamat1">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Alamat 2</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="alamat2" id="alamat2">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Alamat 3</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="alamat3" id="alamat3">
                                </div>
                                <div class="flex justify-end">
                                <button type="button" class="bg-red-200 text-sm font-medium text-red-600 py-2 px-4 rounded-md  active mr-2 mb-5 hover:text-white w-[100px]" id="batal">Batal</button>
                                <button type="submit" class="btn bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 mb-5 hover:text-white w-[100px]" id="simpan" name="proses">Simpan</button>
                                </div>
                            </thead>
                            <tbody>
    ...
    <script>
        ...
        function simpan(){
            let jns = document.getElementById("user").value
            let pesan = ""
            if(jns == ""){
                pesan = "Category Still Empty !!!"
            }
            if(pesan.length > 0){
