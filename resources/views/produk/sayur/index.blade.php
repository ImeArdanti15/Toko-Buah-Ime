                ...
                <div class="grid grid-cols-3 md:grid-cols-6 gap-6">
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      <div class="flex justify-between mb-3">
                        <p class="text-slate-500 text-sm">by Nesya Mulia</p>
                      ...
                      <p class="font-medium text-slate-700">Rp 10.000,00 /ikat</p>
                    </div>
                    <!-- beli  -->
                    <div class="hidden md:block">
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 10.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="hidden md:block">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      <div class="flex justify-between mb-3">
                        <p class="text-slate-500 text-sm">by Naura Aulia Eryazti</p>
                        <div class="flex gap-1 items-cente">
                          <i class="fa-solid fa-star text-yellow-500 text-xs"></i>
                          <p class="text-slate-500 text-xs font-medium">
                            4.5 <span class="font-normal">penilaian</span>
                      ...
                      <p class="font-medium text-slate-700">Rp 15.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="hidden md:block">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      <div class="flex justify-between mb-3">
                        <p class="text-slate-500 text-sm">by Winda Rachmalia</p>
                        <div class="flex gap-1 items-cente">
                          <i class="fa-solid fa-star text-yellow-500 text-xs"></i>
                          <p class="text-slate-500 text-xs font-medium">
                            4.5 <span class="font-normal">penilaian</span>
                      ...
                      <p class="font-medium text-slate-700">Rp 8.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="hidden md:block">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 20.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-500">Rp 10.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="md:block flex align-item-center justify-center">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 28.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="md:block flex align-item-center justify-center">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 7.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="md:block flex align-item-center justify-center">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 29.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="md:block flex align-item-center justify-center">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
                  ...
                  <div class="bg-white rounded-md overvlow-hidden">
                    ...
                    <div class="mt-6 capitalize px-4 pb-8">
                      ...
                      <p class="font-medium text-slate-700">Rp 45.000,00 /kg</p>
                    </div>
                    <!-- beli  -->
                    <div class="md:block flex align-item-center justify-center">
                      <a href="" class="btn bg-lime-500 text-white"><i class="fa-solid fa-cart-shopping mr-3"></i>+</a>
