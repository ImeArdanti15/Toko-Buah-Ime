                ...
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <h3 class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 mb-5 w-[200px]">Edit Pengguna</h3>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Nama</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="name" id="name" value="{{ $pengguna->name }}">
                                </div>
                                <div class="py-4">
                                    <span class="mb-2 text-md text-lime-600">Email</span>
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="email" id="email" value="{{ $pengguna->email }}">
                                </div>
                                <div class="py-4">
                                ...
                                <div class="py-4">
                                    ...
                                    <input type="text" class="w-full p-2 border border-lime-500 rounded-md" name="role" id="role" value="{{ $pengguna->role }}">
                                </div>
                                <div class="flex justify-end">
                                <button type="button" onclick="cancel()" class="bg-red-200 text-sm font-medium text-red-600 py-2 px-4 rounded-md  active mr-2 mb-5 hover:text-white w-[100px]" id="batal">Batal</button>
