...
<body class="text-gray-800 font-inter">
    ...
    <li class="text-lime-600 mr-2 font-medium">Pengguna</li>
    </ul>
            ...
            <div class="bg-white border border-lime-100 shadow-md shadow-lime-600/100 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full main-w-[540px]">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-[12px] uppercase tracking-wide font-medium text-lime-600 py-2 px-4 bg-lime-50 rounded-md">Roles</th>
                        ...
                        <a href="{{route ('user.create')}}" class="bg-lime-200 text-sm font-medium text-lime-600 py-2 px-4 rounded-md  active mr-2 hover:text-white"><i class="fa-solid fa-plus"></i> Tambah User</a>
                    </div>
                            <tbody>
                                                    @foreach ($user as $idx => $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route ('user.edit', $data->id)}}" class="text-lime-400"><i class="fa-solid fa-pencil"></i></a>
                                                                <a href="{{route ('user.destroy', $data->id)}}" class="text-red-400"><i class="fa-solid fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                            </tbody>
