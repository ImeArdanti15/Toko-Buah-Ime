  ...
  <header class="w-full py-8 border border-bold border-solid border-lime-500">
    <nav class="container mx-auto px-4 flex justify-between items-center">
      ...
      <div class="hidden md:block">
        <a href="{{route('admin.login')}}" class="btn bg-lime-500 text-white"><i class="fa-solid fa-right-to-bracket"></i> Masuk</a>
      </div>
      <!-- end right -->
  ...
  <header id="category" class="w-full py-20">
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-4 md:gap-6 ">
        <!-- card -->
        <div class="py-3 px-4 border border-lime-500 rounded-md mb-4 capitalize md:mb-1 md:border-lime-500 text-center hover: bg-lime-100 hover:text-slide-950 group transition-all duration-300">
          <div class="mb-1">
            <i class="fa-solid fa-lemon"></i>
          </div>
          <h2 class="font-semibold mb-2">Buah Segar</h2>
          <p class="text-sm text-slate-500 group-hover:text-slite-900">Buah-buahan segar berasal dari pertanian Indonesia.</p>
        </div>

        <div class="py-3 px-4 border border-lime-500 rounded-md mb-4 capitalize md:mb-1  md:border-lime-500 text-center hover: bg-lime-100 group transition-all duration-300">
          <div class="mb-1">
            <i class="fa-solid fa-apple-whole"></i>
          </div>
          <h2 class="font-semibold mb-2">Buah Lokal Segar</h2>
          <p class="text-sm text-slate-500 group-hover:text-slite-900">pemilihan perkebunan yang bagus sehingga hasil tanaman yang berkualitas.</p>
        </div>
        ...
        <div class="py-3 px-4 border border-lime-500 rounded-md mb-4 capitalize md:mb-1 md:border-lime-500 text-center hover: bg-lime-100 hover:text-slide-950 group transition-all duration-300">
          ...
          <p class="text-sm text-slate-500 group-hover:text-slite-900">sayuran segar yang berasal dari pertanian Indonesia.</p>
        </div>
      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-end mb-12">
          ...
          <div class=" mb-3 hidden md:block">
            <a href="{{route('produk')}}" class="w-full inline-block text-center rounded-md font-semibold py-3 px-6 text-sm border border-lime-500 text-lime-500 hover:opacity-70">Lihat semua</a>
          </div>
        </div>
          <!-- end kanan -->
